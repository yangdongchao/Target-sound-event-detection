...
class Runner(object):
    ...
    def train(self, config, **kwargs):
        ...
        model = getattr(models, config_parameters['model'])(model_config=config_parameters,inputdim=64, 
                                                           outputdim=2, **config_parameters['model_args'])
        ...
        if config_parameters['optimizer'] == 'AdaBound':
            ...
            # optimizer = getattr(torch.optim,config_parameters['optimizer'])([{'params': model.encoder.parameters()},
            #                     {'params': model.detection.parameters(),'lr': config_parameters['lr_']*20}],lr=config_parameters['lr_'])
