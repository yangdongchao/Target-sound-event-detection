...
weak_csv = '/home/ydc/wsed/target_sound_detection/data/flists/urban_sed_test_weak.tsv'
DF_weak = pd.read_csv(weak_csv, sep='\t',usecols=[0,1])  # only read first cols, allows to have messy csv

strong_csv = '/home/ydc/wsed/target_sound_detection/data/flists/urban_sed_test_strong.tsv'
...
frames_num = 501
num_freq_bin = 64
hf = h5py.File('/data/ydc_data/urban_target_detection_test_new_name.h5', 'w')
hf.create_dataset(
    name='filename', 
    shape=(0,), 
    maxshape=(None,),
...
for i,filename in enumerate(weak_filename):
    ...
    print(i,basename)
    strong_name = '/home/ydc/wsed/CDur/data/URBAN-SED/audio/test/'+basename
